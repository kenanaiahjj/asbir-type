...
function render() {
  ...
  const heroDownload = isSans
    ? '<a class="hero-download" href="/downloads/AsbirSans-1.1.1.zip" download>Download Asbir Sans 1.1.1 ZIP <b>↓</b></a>'
    : '<a class="hero-download" href="/downloads/AsbirMono-1.1.1.zip" download>Download Asbir Mono 1.1.1 ZIP <b>↓</b></a>';
  ...
  app.innerHTML = `
    <header class="site-header">
      ...
      <div class="header-family">
        ...
        <span>Typeface specimen / ${isSans || isMono ? '1.1.1' : 'review'}</span>
      </div>
...
function renderFamilyContent(family) {
  ...
  const story = isMono ? {
    ...
    foot: ['600-unit advance / slashed zero', 'Code + data + technical UI', 'Asbir Mono / 1.1.1'],
  } : {
    ...
    foot: ['High lowercase / open apertures', 'Product UI + brand identity', 'Asbir Sans / 1.1.1'],
  };
  const release = isMono ? {
    heading: 'Asbir Mono 1.1.1 is ready to ship.', description: 'The approved Asbir Mono release: Roman and true italic families, default coding ligatures, technical Unicode arrows, clean production binaries, and a separately named Nerd Font / Powerline terminal TTF.',
    action: '<a class="release-download" href="/downloads/AsbirMono-1.1.1.zip" download>Download all Asbir Mono files <b>↓</b></a>',
    status: '1.1.1 · approved', axes: 'wght 100—900', coverage: 'Latin / Cyrillic<br>Vietnamese / symbols', license: 'Asbir Mono is an OFL-compliant derivative of Geist Mono. It may be used, studied, modified, embedded, and redistributed under the terms of the license.',
  } : {
    heading: 'Asbir Sans 1.1.1 is ready to ship.', description: 'The approved Asbir Sans release for product, brand, and engineering. Download the complete family or choose a format below.',
    action: '<a class="release-download" href="/downloads/AsbirSans-1.1.1.zip" download>Download all Asbir Sans files <b>↓</b></a>',
    status: '1.1.1', axes: 'wght 100—900<br>opsz 14—32', coverage: 'Latin / Greek<br>Cyrillic / Vietnamese', license: 'Asbir Sans is an OFL-compliant derivative of Inter. It may be used, studied, modified, embedded, and redistributed under the terms of the license.',
  };
  return `
